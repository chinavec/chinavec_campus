...
$(function() {
	...
	$("#authForm").submit(function() {
			if ($("#mail").val() && $("#name").val() && $("#content").val()&& $("#mp").val()) {
							return true;
						}
						else {
							alert("请填写完整信息！");
...
<body>
    ...
    <div id="container" class="clearfix">
        ...
        <div id="container_right" class="right" style="text-align:center">
                ...
                <form id="searchInput" action="searchth" method="get">
                  <tr> 
           ...
           <form name="input" id="authForm" action="photoaddpro.php" method="POST" enctype="multipart/form-data" >
		
			  <table class="newtable" width="90%" style="margin: auto">
				<thead>
    <div style="text-align:left;margin-left:40px;font-size:15px;"><font color='red'>*</font>为必填项</div><br/>  
       <!-- <td width="10%">编号</td>
        <td><input type="text" name="id" /></td>-->
    </tr>
    <tr>
        <td width="10%">姓名</td>
        <td><input type="text" name="name" id="name" style="width:50%;height:100%;"/><font color='red'>*</font></td> 
    </tr> 
	<tr>
        <td width="10%">手机</td>
        <td><input type="text" name="mp" id="mp" style="width:50%;height:100%;"/><font color='red'>*</font></td>
    </tr>
<tr>
        <td width="10%">邮箱</td>
        <td><input type="text" name="mail" id="mail" style="width:50%;height:100%;"/><font color='red'>*</font></td>
    </tr>
<tr>
        <td class="tableleft">个人简介</td>
        <td><textarea name="dscrp" id="content" title="content" rows="8" cols="40" style="width:450px;height:150px;"></textarea><font color='red'>*</font></td>
    </tr> 
    </tr>
	<tr>
        <td class="tableleft">星座</td>
                         <td>
                            <select name="star" id="star" title="分类">
                                <option value="" selected="selected">请选择星座</option>
