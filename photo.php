			 ...
			 <table class="mytable" width="95%" style="margin-right: auto;margin-left: auto;">
				<thead>
                    <tr>
						...
						<th width="1%" align="center" valign="middle" background="img/bm.jpg"><img src="img/hsx.gif" alt="" width="1" height="7" /></th>
                        <th width="15%" align="center" valign="middle" background="img/bm.jpg" class="font-hui14">邮箱</th>
                        <th width="1%" align="center" valign="middle" background="img/bm.jpg"><img src="img/hsx.gif" alt="" width="1" height="7" /></th>
                        <th width="10%" align="center" valign="middle" background="img/bm.jpg" class="font-hui14">类别</th>
                        <th width="1%" align="center" valign="middle" background="img/bm.jpg"><img src="img/hsx.gif" alt="" width="1" height="7" /></th>
...
<div>
	<tr class="distr" >
			<td width="8%" align="center" valign="middle" class="font-hui">{$result_row['id']}</td>
                        ...
                        <td width="19%" align="center" valign="middle" class="font-hui">$mail</td>
						<td width="11%" align="center" valign="middle" class="font-hui">$Type</td>
						<td width="18%" align="center" valign="middle" class="font-hui">$abstract</td>
