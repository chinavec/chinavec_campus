...
<body>
    ...
    <div id="container" class="clearfix">
        ...
        <div id="container_right" class="right" style="text-align:center">
           ...
           <form name="input" action="newspro.php" method="POST" >
		
			  <table class="newtable" width="90%" style="margin: auto">
				<thead>
         <tr> 
        <td width="10%">标题</td>
        <td><input type="text" name="title" id="title" style="width:70%;height:100%;" /></td>
    </tr>
    <tr>
        <td class="tableleft">内容</td>
            
        <td><div>
<textarea name="content" type="text/plain" id="myEditor" style="width:600px;height:240px;"></textarea></div></td>
    </tr>   
    <tr><!--<textarea name="content" id="content" title="content" rows="8" cols="40" style="width:500px;height:160px;"></textarea>-->
